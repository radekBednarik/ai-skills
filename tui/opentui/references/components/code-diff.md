...
// Solid
<code code={sourceCode} language="javascript" />
...
```tsx
// React
<line-number code={sourceCode} language="typescript" />

// Solid (note underscore)
<line_number code={sourceCode} language="typescript" />
...
// Solid
<line_number code={sourceCode} language="typescript" startLine={1} showLineNumbers={true} />
```
...
```tsx
// React
<line-number code={sourceCode} language="typescript" highlightedLines={[5, 10, 15]} />

// Solid
<line_number code={sourceCode} language="typescript" highlightedLines={[5, 10, 15]} />
```
...
<line_number
  code={sourceCode}
  language="typescript"
  diagnostics={[{ line: 3, severity: "error", message: "Unexpected token" }]}
/>
```
...
```tsx
// React
<diff oldCode={originalCode} newCode={modifiedCode} language="typescript" />
...
```tsx
// React
<markdown content={markdownText} syntaxStyle={mySyntaxStyle} />
